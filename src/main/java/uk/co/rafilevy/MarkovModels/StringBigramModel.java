 ...
 */
public class StringBigramModel extends MarkovModel<Pair<String, String>> implements TextGenerativeModel {
    private static final Pair<String, String> defaultStartPair = new Pair("\\s", "\\s");
    private static final Pair<String, String> defaultEndPair = new Pair("\\e", "\\e");

    private final Pair<String, String> startPair;
    private final Pair<String, String> endPair;

    private StringBigramModel(MarkovModel<Pair<String, String>> model, Pair<String, String> startPair, Pair<String, String> endPair) {
        super(model);
        this.startPair = startPair;
        this.endPair = endPair;
    }

    private static List<Pair<String, String>> stringToBigramSequence(String s, String regex, Pair<String, String> startPair, Pair<String, String> endPair) {
        List<Pair<String, String>> bigramSequence = new ArrayList<>();
    ...
    private static StringBigramModel fromStrings(Collection<String> strings, String regex, Pair<String, String> startPair, Pair<String, String> endPair) {
        Set<List<Pair<String, String>>> bigramSequences = strings.stream().map( (String s) -> StringBigramModel.stringToBigramSequence(s, regex, startPair, endPair) ).collect(Collectors.toSet());
    ...
    public String generateString() {
        List<Pair<String, String>> sequence = super.generateSequence(startPair, endPair);
